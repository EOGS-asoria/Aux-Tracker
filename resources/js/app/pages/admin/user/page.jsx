...
import { get_account_thunk } from "../account/redux/account-thunk"; // Import the thunk

export default function AdminUserdPage() {
    useEffect(() => {
        store.dispatch(get_position_thunk()); 
        store.dispatch(get_account_thunk()); // Fetch accounts
    }, []); // Ensure to include the dependency array
    return (
        <AdminLayout>
