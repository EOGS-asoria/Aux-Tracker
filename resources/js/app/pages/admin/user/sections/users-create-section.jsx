                            ...
                            export default function UsersCreateSection() {
                                ...
                                const { sites } = useSelector(state => state.sites); // Correctly accessing sites
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            <form onSubmit={handleSubmit}>
                                                ...
                                                <div className="mb-4">
                                                    <Select
                                                        options={positions && positions.data ? positions.data.map((pos) => ({
                                                            value: pos.account,
                                                            label: pos.account,
                                                        })) : []}
                                                ...
                                                <div className="mb-4">
                                                    <Select
                                                        options={accounts && accounts.data ? accounts.data.map((acc) => ({
                                                ...
                                                <div className="mb-4">
                                                    <Select
                                                        options={sites && sites.data ? sites.data.map((site) => ({
                                                            value: site.site_name,
                                                            label: site.site_name,
                                                        })) : []} // Correctly mapping sites
                                                        value={newAgent.site}
                                                        onChange={(e) =>
                                                            handleChange({
                                                                target: {
