...
export default function SiteView() {
    ...
    const [sites, setSites] = useState([
        ...
        { id: 3, site: '3rd Site San Carlos', location: 'San Carlos', status: 'Active' },
        { id: 4, site: 'Downtown Site', location: 'Downtown', status: 'Active' },
        { id: 5, site: 'Uptown Site', location: 'Uptown', status: 'Inactive' }
    ]);
                        ...
                        },
                        {
                            ...
                            render: (_, record) => (
                                <div className="flex space-x-4">
                                    <button onClick={() => clickMe(record.id)} className="text-blue-500 hover:underline">View Details</button>
                                    <button
